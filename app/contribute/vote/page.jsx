...
const FEATURES = [
  ...
  { id: 4, label: "Improve import and export functionality" },
  { id: 5, label: "[Foundry] Allow linking locations to other maps (can be used for a regional map inside a world map)" },
  { id: 6, label: "Allow for uploading custom STL file. For 3D drawer view" },
  ...
  { id: 18, label: "add iframe in drawer which links to fandom/wiki page" },
]
