...
export const createEarthPlanet = ({ colors, pixels, seed, landPercent, cloudPercent, clouds }) => {
  ...
  // lightPos = new Vector2(0.39, 0.7), lightIntensity = 0.1, colors = null, rotationSpeed = 0.1, rotation = 0.0, landPercent = 0.6
  const landmass = createlandMassLayer(undefined, undefined, colors, undefined, undefined, landPercent, pixels, seed)
  ...
  if (clouds) {
    const cloudsLayer = createCloudLayer(colors, undefined, undefined, undefined, cloudPercent, undefined, pixels, seed)
