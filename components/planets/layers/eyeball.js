...
export function createBaseEyeballPlanet(lightPos = new Vector2(0.3, 0.3), lightIntensity = 0.1, colors, rotationSpeed = 0, rotation = 0.1, pixels, seed) {
  let colorPalette = [
    new Vector4(0.86, 0.90, 0.94, 1.0),
    new Vector4(0.42, 0.50, 0.60, 1.0),
    new Vector4(0.10, 0.13, 0.18, 1.0),
  ]
