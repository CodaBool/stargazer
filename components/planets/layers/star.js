import { Mesh, PlaneGeometry, ShaderMaterial, Vector2, TextureLoader, NearestFilter } from "three";
...
export function createStar(lightPos = new Vector2(0.39, 0.7), lightIntensity = 0.1, rotationSpeed = 0.01, rotation = 0.0, colors, pixels, seed) {
  ...
  const palette = colors.scheme ? `/threejs/starPalette/${colors.scheme}Palette.png` : "/threejs/starPalette/orangePalette.png"
