...
export function getConsts(map) {
  const DEFAULTS = {
    ...
    TYPES: {
      ...
      "point": ["station", "jovian", "moon", "terrestrial", "desert_planet", "ocean_planet", "barren_planet", "ice_planet", "asteroid", "lava_planet", "ringed_planet", "gate", "black_hole", "wormhole", "exoplanet", "ship", "star", "neutron_star", "comet", "unknown"],
