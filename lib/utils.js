...
export function gridHelpers(name, GRID_DENSITY) {
  ...
  function axisCell(deg, alignment) {
    if (name === 'alien') {
  ...
  function coordFromLngLat(lon, lat) {
    ...
    const cCol = axisCell(fixNegZero(lon), true);
    const cRow = axisCell(fixNegZero(lat), false);
