...
export function createPopupHTML(e, isGalaxy, map) {
  ...
  let svgBase = "https://raw.githubusercontent.com/CodaBool/stargazer/refs/heads/main/public/svg/"
    ...
    if (style === "stroke") {
      ...
      return [
        ...
        [
          ...
          ["==", ["get", "type"], "imperial"], "#fff1ab", // light gold
          ["==", ["get", "type"], "unclassified"], "#949494", // light grey
