...
export function getConsts(map) {
  const DEFAULTS = {
    ...
    IGNORE_POLY: ["line", "grid", "bg", "bg-radiated"],
    VIEW: {
      longitude: 0,
      latitude: 0,
      zoom: 1,
    ...
    if (style === "stroke") {
      ...
      return [
        ...
        [
          ...
          ["==", ["get", "name"], "Little Europe"], "rgba(255, 0, 197, 0.05)", // purple, looks good
          ["==", ["get", "name"], "Upper Marina"], "rgba(0, 197, 255, 0.1)", // blue
          ["==", ["get", "name"], "Hot Zone"], "rgba(0, 0, 0, .35)", // black, looks good
          ...
          ["==", ["get", "name"], "Rancho Coronado"], "rgba(255, 0, 212, 0.06)", // purple
