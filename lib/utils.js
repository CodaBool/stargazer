...
export function getConsts(map) {
  const DEFAULTS = {
    ...
    TYPES: {
      ...
      "point": ["station", "jovian", "moon", "terrestrial", "desert planet", "ocean planet", "barren planet", "ice planet", "asteroid", "lava planet", "ringed planet", "gate", "black hole", "wormhole", "exoplanet", "star", "neutron star", "comet", "unknown"],
