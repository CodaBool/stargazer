...
Which can be used in any map application.

### ✨ Yet Another Stylized Map
In addition to the goal of consolidating map data. I will be creating my own stylized version of each map. Click the link at the top to see it.
